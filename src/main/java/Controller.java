...
public class Controller extends Application {
    ...
    /*
     Launches the Controller class and thus the HomeScreen
     The Controller inherits from the JavaFX Application class
     */
    ...
    The Controller.java class was set as the Controller class in Scene Builder
